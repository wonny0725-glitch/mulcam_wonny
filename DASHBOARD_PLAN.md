# 서울교통공사 지하철 혼잡도(Streamlit) 대시보드 구현 계획
...
### Phase 1 — 데이터 로딩/전처리 모듈 (0.5~1일)
- CSV 인코딩 처리(cp949/euc-kr)
- wide→long 변환(`melt`)으로 `time/hhmm/minute/crowding` 컬럼 생성
